...
jQuery(document).ready(function($) {
	...
	$('.agsdi_icons_delete').click(function() {
		$(this).prev('input').prop('name', 'delete[]').closest('label').hide();
		return false;
	});
	
	$('.wadip-reload-button').click(function() {
		location.reload();
	});
...
window.agsdi_multicolor = {
	sets: {
		uni: wp.i18n.__('Universal', 'ds-icon-expansion'),
		lin: wp.i18n.__('Lineal', 'ds-icon-expansion'),
		out: wp.i18n.__('Outline', 'ds-icon-expansion'),
		mul: wp.i18n.__('Multicolor', 'ds-icon-expansion'),
		han: wp.i18n.__('Hand Drawn', 'ds-icon-expansion'),
		fil: wp.i18n.__('Filled', 'ds-icon-expansion'),
		ske: wp.i18n.__('Sketch', 'ds-icon-expansion'),
		tri: wp.i18n.__('Tri-Color', 'ds-icon-expansion'),
		ele: wp.i18n.__('Elegant', 'ds-icon-expansion')
	},
	icons: {
	uni: [
		{
			id: 'universal-gen',
			prefix: 'mcip-uni-gen-',
			label: wp.i18n.__('Universal General', 'ds-icon-expansion'),
		...
		},
		{
			id: 'universal-off',
			prefix: 'mcip-uni-off-',
			label: wp.i18n.__('Universal Office', 'ds-icon-expansion'),
			icons: [ 'coffee', 'email', 'phone', 'briefcase', 'calendar', 'assistant', 'calculator']
		},
		{
			id: 'universal-eco',
			prefix: 'mcip-uni-eco-',
			label: wp.i18n.__('Universal Ecommerce', 'ds-icon-expansion'),
		...
		},
		{
			id: 'universal-web',
			prefix: 'mcip-uni-web-',
			label: wp.i18n.__('Universal Web', 'ds-icon-expansion'),
			icons: ['laptop', 'link', 'marketing', 'advertisement', 'analytics', 'search',  'design',  'devices', 'browser', 'hamburger_menu']
		},
		{
			id: 'universal-bra',
			prefix: 'mcip-uni-bra-',
			label: wp.i18n.__('Universal Brands', 'ds-icon-expansion'),
			icons: ['twitter', 'divi', 'facebook', 'instagram', 'youtube','wordpress']
		},
		{
			id: 'universal-edu',
			prefix: 'mcip-uni-edu-',
			label: wp.i18n.__('Universal Education', 'ds-icon-expansion'),
	...
	lin: [
		{
			id: 'lineal-cle',
			prefix: 'mcip-lin-cle-',
			label: wp.i18n.__('Lineal Cleaning', 'ds-icon-expansion'),
	...
	out: [
		{
			id: 'outline-gen',
			prefix: 'mcip-out-gen-',
			label: wp.i18n.__('Outline General', 'ds-icon-expansion'),
			icons: ['calendar', 'flower', 'chat', 'gear', 'check', 'heart', 'honey', 'post', 'user', 'location', 'lock',  'drop']
		},
		{
			id: 'outline-web',
			prefix: 'mcip-out-web-',
			label: wp.i18n.__('Outline Web', 'ds-icon-expansion'),
			icons: ['phone', 'tablet', 'cursor', 'loupe', 'shield', 'web', 'mail']
		},
		{
			id: 'outline-eco',
			prefix: 'mcip-out-eco-',
			label: wp.i18n.__('Outline Ecommerce', 'ds-icon-expansion'),
			icons: ['basket', 'money', 'credit_card', 'delivery', 'shipment', 'support']
		},
		{
			id: 'outline-hea',
			prefix: 'mcip-out-hea-',
			label: wp.i18n.__('Outline Health', 'ds-icon-expansion'),
		...
		},
		{
			id: 'outline-spo',
			prefix: 'mcip-out-spo-',
			label: wp.i18n.__('Outline Sport', 'ds-icon-expansion'),
			icons: ['run', 'weights',]
		},
	],
	mul: [
		{
			id: 'multicolor-gen',
			prefix: 'mcip-mul-gen-',
			label: wp.i18n.__('Multicolor General', 'ds-icon-expansion'),
			icons: [  'new',  'notepad', 'settings', 'email',  'share',  'phone', 'localization',  'calendar',  'question',  'report', 'time',  'map',  'currency', 'search', ]
		},
		{
			id: 'multicolor-eco',
			prefix: 'mcip-mul-eco-',
			label: wp.i18n.__('Multicolor Ecommerce', 'ds-icon-expansion'),
		...
		},
		{
			id: 'multicolor-web',
			prefix: 'mcip-mul-web-',
			label: wp.i18n.__('Multicolor Web', 'ds-icon-expansion'),
	...
	han: [
		{
			id: 'hand-drawn-gen',
			prefix: 'mcip-han-gen-',
			label: wp.i18n.__('Hand Drawn General', 'ds-icon-expansion'),
		...
		},
		{
			id: 'hand-drawn-off',
			prefix: 'mcip-han-off-',
			label: wp.i18n.__('Hand Drawn Office', 'ds-icon-expansion'),
			icons: [ 'location', 'location_2', 'mail', 'list_with_accent', 'pencil', 'book_with_accent', 'calendar', 'time', 'coffee',  'contact',]
		},
		{
			id: 'hand-drawn-ani',
			prefix: 'mcip-han-ani-',
			label: wp.i18n.__('Hand Drawn Animals', 'ds-icon-expansion'),
		...
		},
		{
			id: 'hand-drawn-non',
			prefix: 'mcip-han-non-',
			label: wp.i18n.__('Hand Drawn Nonprofit', 'ds-icon-expansion'),
			icons: [ 'hand_leaf', 'hands','house_with_accent', 'leaf_heart', 'drop_with_accent', 'bowl', 'bowl_2', 'bowl_3',  'sleep', 'bread',  'world_with_heart', ]
		},
		{
			id: 'hand-drawn-bra',
			prefix: 'mcip-han-bra-',
			label: wp.i18n.__('Hand Drawn Brands', 'ds-icon-expansion'),
			icons: ['instagram', 'facebook', 'twitter', 'youtube']
		},
		{
			id: 'hand-drawn-num',
			prefix: 'mcip-han-num-',
			label: wp.i18n.__('Hand Drawn Numbers', 'ds-icon-expansion'),
	...
	fil: [
		{
			id: 'filled-fil-gen',
			prefix: 'mcip-fil-gen-',
			label: wp.i18n.__('Filled', 'ds-icon-expansion'),
			icons: ['mail', 'settings', 'shield', 'calendar', 'gear', 'umbrella', 'check', 'user', 'lock', 'post', ]
		},
		{
			id: 'filled-eco',
			prefix: 'mcip-fil-eco-',
			label: wp.i18n.__('Filled Ecommerce', 'ds-icon-expansion'),
			icons: ['location', 'basket', 'shipment', 'credit_card', 'delivery', 'phone', 'support', 'money', 'setup', 'chat' ]
		},
		{
			id: 'filled-web',
			prefix: 'mcip-fil-web-',
			label: wp.i18n.__('Filled Website', 'ds-icon-expansion'),
			icons: ['web', 'cursor', 'desktop',]
		},
		{
			id: 'filled-pho',
			prefix: 'mcip-fil-pho-',
			label: wp.i18n.__('Filled Photography', 'ds-icon-expansion'),
	...
	ske: [
		{
			id: 'sketch-gen',
			prefix: 'mcip-ske-gen-',
			label: wp.i18n.__('Sketch General', 'ds-icon-expansion'),
		...
		},
		{
			id: 'sketch-pod',
			prefix: 'mcip-ske-pod-',
			label: wp.i18n.__('Sketch Podcast', 'ds-icon-expansion'),
	...
	ele: [
		{
			id: 'elegant-gen',
			prefix: 'mcip-ele-gen-',
			label: wp.i18n.__('Elegant General', 'ds-icon-expansion'),
			icons: [ 'cursor', 'invitation', 'mail', 'calendar', 'user',  'music', 'web', 'gear', 'phone', 'chat', 'check', 'post',  ]
		},
		{
			id: 'elegant-eco',
			prefix: 'mcip-ele-eco-',
			label: wp.i18n.__('Elegant eCommerce', 'ds-icon-expansion'),
			icons: ['shield', 'basket', 'shipment','location', 'support','delivery', 'money', 'credit',]
		},
		{
			id: 'elegant-wed',
			prefix: 'mcip-ele-wed-',
			label: wp.i18n.__('Elegant Wedding', 'ds-icon-expansion'),
	...
	disable: function() {
		...
		this.resetFilters(function() {
			...
			jQuery('#et-fb-icon_picker li:last').click();
			setTimeout(function() {
				jQuery('#et-fb-icon_picker li:first').click();
			}, 500);
		});
			...
			window.et_gb.wp.hooks.addFilter(
				...
				function(action) {
					if (action.actionType === 'MODULE_EDIT_SETTINGS_CHANGE') {
						if (window.et_gb.agsdi_multicolor.isEnabled() && action.setting === 'icon_pack_select') {
							window.et_gb.agsdi_multicolor.setIconStyle(action.newValue.substring(4));
						}
					}
					return action;
...
jQuery(document).ready(function($) {
	...
	$('#agsdi_mc_packs').bind('click', function() {
		$('.agsdi-load-icon-sets-wrapper-multicolor input').prop('checked', $( this)[0].checked);
	});
	$('.agsdi-load-icon-sets-wrapper-multicolor input').bind('click', function() {
		$('#agsdi_mc_packs').prop('checked', $( this)[0].checked);
		$('.agsdi-load-icon-sets-wrapper-multicolor input').prop('checked', $( this)[0].checked);
	});
});
//!free exclude end
